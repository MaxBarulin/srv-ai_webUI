...
const perks = [
  ...
  ["Честная очередь", "Модель на CPU обрабатывает запросы последовательно; в интерфейсе — статус «В очереди: N»."],
...
const docBlocks = [
  ...
  <ul>
    ...
    <li>Два слота (<code>-np 2</code>): два сотрудника считаются одновременно, остальные видят статус «В очереди»</li>
